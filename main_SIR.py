...
class SIRSimulation:
    def __init__(self, master):
        ...
        ttk.Label(master, text="Neighbor Infectivity").grid(row=4, column=1, sticky="w")
    ...
    def _get_non_neighbor_susceptible_cell(self, i, j, susceptible_indices):
        ...
        for ni, nj in susceptible_indices:
            # Check if the cell is not a neighbor (including diagonal)
    ...
    def draw_grid(self):
        ...
        self.ax_grid.imshow(show_grid, cmap=self.cmap, vmin=0, vmax=2)
